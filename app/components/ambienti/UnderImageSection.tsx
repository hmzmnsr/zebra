...
const UnderImageSection = () => {
  return (
    <div className="py-8 sm:py-24 lg:pt-28 lg:pb-12" style={{ backgroundColor: '#2b2b2e' }}>
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-32">
        {/* Header Area */}
        <div className="mb-4 sm:mb-12 leading-none">
          <h3 className="text-white text-[20px] leading-none" style={{ fontWeight: 400 }}>
          L ambiente di lavoro come espressione dell innovazione
          </h3>
          <h2 className="text-[48px] text-white leading-none" style={{ fontWeight: 250 }}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 sm:gap-12 mt-8 sm:mt-20 lg:mt-24">
          <div className="text-white text-[20px] leading-none" style={{ fontWeight: 400 }}>
