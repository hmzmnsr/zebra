...
const PowerToolSection = () => {
  return (
    <section className="text-white relative mb-10 md:mb-20 pb-6 md:pb-40" style={{ background: 'linear-gradient(to bottom, #1d2928, #242626)' }}>
         ...
         <div className="flex items-center justify-center p-4 md:p-8 lg:p-1">
           <div className="relative w-full h-full">
             <Image
               ...
               width={1000}
               height={400}
               className="w-full max-w-4xl h-64 md:h-108 object-cover"
             />
           </div>
         </div>
      </div>
