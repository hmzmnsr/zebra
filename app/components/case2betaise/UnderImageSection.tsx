...
const UnderImageSection = () => {
  return (
    <div className="relative pb-16 sm:pb-24 lg:pb-32 bg-white px-0 lg:px-24">
      {/* Overlapping Image - Top Right Corner */}
      <div className="absolute top-4 right-7 z-10 w-1/3 lg:w-2/5 h-full">
        <Image
          src="/assets/case2betaise/x.png"
          alt="Decorative Image"
          width={200}
          height={50}
          className="w-full h-auto object-contain transform -translate-y-20 lg:-translate-y-32 rotate-[30deg]"
        />
      </div>
      ...
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 mt-16 sm:mt-20 lg:mt-24 mr-104">
