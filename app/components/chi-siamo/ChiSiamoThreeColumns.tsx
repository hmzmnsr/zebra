...
const ChiSiamoThreeColumns = () => {
  return (
    <section className="bg-[#FBFDFC] text-[#083933] py-12 md:py-2">
          ...
          <div className="relative m-8 sm:m-16">
            <div className="relative">
               <Image
                 ...
                 width={400}
                 height={600}
                 className="object-cover rounded-lg w-full h-[50vh]"
                 priority
               />
            </div>
          </div>
           ...
           <div className="flex flex-col justify-center space-y-6 md:space-y-1">
             ...
             <div className="space-y-6 sm:space-y-8 mt-8 sm:mt-36">
               ...
               <div className="space-y-3 sm:space-y-4">
                 <p className="text-sm sm:text-base text-[#083933] leading-relaxed">
...
export default ChiSiamoThreeColumns; 