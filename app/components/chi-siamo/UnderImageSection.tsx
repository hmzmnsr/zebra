    ...
    <div className="pt-16 pb-8 sm:pb-16 md:pb-24 lg:pb-32 bg-[#FBFDFC] px-0 lg:px-24 text-[#083933] ">
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-12">
        ...
        <div className="mb-4 sm:mb-8 md:mb-12 leading-tight">
          <h3 className="text-[#083933] text-xs leading-tight" style={{ fontWeight: 400 }}>
          Un vettore verso l&apos;innovazione
          </h3>
          <h2 className="text-2xl sm:text-3xl md:text-3xl lg:text-4xl text-[#083933] leading-tight" style={{ fontWeight: 250 }}>
          Il nostro percorso
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8 md:gap-12 mt-8 sm:mt-16 md:mt-20 lg:mt-24">
          ...
          <div className="text-[#083933] text-sm leading-tight pl-0 sm:pl-8 md:pl-16 lg:pl-20" style={{ fontWeight: 400 }}>
