...
const CTASection = () => {
  return (
    <div className="w-full h-[750px] bg-[#FBFDFC] text-[#083933] flex flex-col justify-center items-center">
      <div className="max-w-8xl mx-auto px-4 sm:px-6 text-center">
        <div className="mb-2 sm:mb-8 md:mb-8 mt-2 sm:mt-12 md:mt-16 lg:mt-20 xl:mt-44">
          <h2 className="text-[#083933] text-[60px] leading-none px-2 sm:px-4" style={{ fontWeight: 430 }}>
        ...
        <div className="flex justify-center mt-2 sm:mt-8 md:mt-8 lg:mt-12 xl:mt-44">
          <Link 
            href="/contatti" 
            className="inline-flex items-center text-[#083933] hover:text-gray-300 transition-colors text-[32px] px-4 py-2 sm:px-6 sm:py-3"
          >
