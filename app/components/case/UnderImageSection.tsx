...
const UnderImageSection = () => {
  return (
    <div className="relative pb-12 sm:pb-16 lg:pb-88 px-4 sm:px-6 lg:px-24">
      {/* Overlapping Image - Top Right Corner - Hidden on mobile, shown on larger screens */}
      <div className="hidden md:block absolute -top-32 sm:-top-40 md:-top-84 right-0 z-10 w-2/3 lg:w-3/5 h-full">
        <Image
      ...
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 md:gap-12 mt-12 sm:mt-16 md:mt-20 lg:mt-24 mr-0 sm:mr-0 md:mr-104">
          ...
          <div className="text-[#082239] text-[20px] leading-none pl-0 sm:pl-0 md:pl-20" style={{ fontWeight: 400 }}>
