    ...
    <div className="pb-16 sm:py-20 lg:pb-12 lg:pt-36 bg-[#FBFDFC]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 text-center">
        <div className="sm:mb-8 mt-20">
          <h2 className="text-black text-xl sm:text-2xl md:text-3xl lg:text-4xl leading-none" style={{ fontWeight: 430 }}>
        ...
        <div className="flex justify-center mt-8 sm:mt-12 lg:mt-44">
          <Link 
            href="/contatti" 
            className="inline-flex items-center text-black hover:text-gray-300 transition-colors text-base sm:text-lg lg:text-2xl font-medium"
          >
