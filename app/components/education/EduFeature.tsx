          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 md:gap-8 items-start">
            ...
            <div className="space-y-4 md:space-y-6 relative lg:col-span-2 flex flex-col h-[45vh] md:h-[70vh] order-1 lg:order-2">
              ...
              <div className="space-y-2 flex-1">
                <h2 className="text-[20px] text-gray-900 leading-none">
                  1
                </h2>
                {/* Logo */}
                ...
                <p style={{ fontWeight: 500 }} className="text-[#082239] leading-none text-[20px] mt-4 md:mt-8">
                  <span style={{ fontWeight: 500 }}>Tecnologia integrata:</span>
                </p>
                <ul className="text-gray-600 leading-none text-[20px] mt-2 space-y-1 list-disc list-inside pl-4">
                ...
                <p style={{ fontWeight: 400 }} className="text-[#082239] leading-none text-[20px] mt-4 md:mt-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 md:gap-8 items-start">
            ...
            <div className="space-y-4 md:space-y-6 relative lg:col-span-2 flex flex-col h-[45vh] md:h-[70vh] order-1 lg:order-2">
              ...
              <div className="space-y-2 flex-1">
                ...
                <p className="text-gray-600 leading-none text-[20px] mt-4 md:mt-5">
