...
const ImmersiveMultimediaSectionOne = () => {
  ...
  return (
    ...
    >
      ...
      <div className={`absolute inset-0 md:block hidden transition-opacity duration-700 ease-in-out ${isFading ? 'opacity-0' : 'opacity-100'}`}>
        <Image
          src={activeContent?.image || '/assets/homepage/bg2.jpg'}
      ...
      <div className="absolute top-0 left-0 right-0 z-10">
        <div className="bg-black/30 backdrop-blur-md p-3 md:p-4 shadow-2xl">
          <div className="flex items-center pt-2 md:pt-4 md:pb-2">
            <span className="text-white text-lg md:text-2xl font-thin mr-2 md:mr-3">2</span>
            <h2 className="text-lg md:text-2xl font-thin text-white leading-tight ml-8 md:ml-24">
            Conferencing, design thinking, training e presentazione
            </h2>
          </div>
        </div>
      </div>
      ...
      <div className="hidden md:block">
        ...
        <Link 
          ...
          className="absolute bottom-4 md:bottom-10 right-2 md:right-10 z-10 pl-8 md:pl-36 pr-2 md:pr-4 pt-8 md:pt-52 pb-2 md:pb-4 text-white border border-white/80 
...
export default ImmersiveMultimediaSectionOne; 