    ...
    >
      ...
      <div className="hidden md:block">
        ...
        <Link 
          ...
          className="absolute bottom-4 md:bottom-10 right-2 md:right-10 z-10 pl-8 md:pl-34 pr-2 md:pr-4 pt-8 md:pt-46 pb-2 md:pb-4 text-white border border-white/80 
