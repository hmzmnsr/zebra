...
const ImmersiveMultimediaSectionThree = () => {
  const menuItems = [
    { id: 1, title: 'UX-UI Design', active: true },
    { id: 2, title: 'Sviluppo applicazioni', active: false },
  ];
...
export default ImmersiveMultimediaSectionThree; 