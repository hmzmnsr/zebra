        ...
        <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-1">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="order-2">
              <h3 className="text-black text-md font-thin px-4 sm:px-8 lg:px-32">
              Soluzioni su misura
              </h3>
              <h2 className="text-black text-4xl md:text-5xl lg:text-4xl font-thin leading-tight px-4 sm:px-8 lg:px-32 mb-4">
              Software development
              </h2>
              <div className="w-16 h-px bg-white mb-6 mx-4 sm:mx-8 lg:mx-32"></div>
              <p className="text-black text-sm leading-tight px-4 sm:px-8 lg:px-32 font-thin">
