...
const UnderImageSection = () => {
  return (
    <div className="py-16 sm:py-24 lg:pt-32 lg:pb-12" style={{ backgroundColor: '#252928' }}>
      <div className="max-w-8xl mx-auto pl-32 sm:px-6 lg:px-8">
        {/* Header Area */}
        <div className="mb-8 sm:mb-12 leading-none">
          <h3 className="text-[#fbfdfc] text-[20px] leading-none text-center lg:text-left" style={{ fontWeight: 400 }}>
            Diamo vita alle tue idee
          </h3>
          <h2 className="text-[48px] text-[#fbfdfc] leading-none text-center lg:text-left" style={{ fontWeight: 250 }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-12 mt-12 sm:mt-16 lg:mt-24">
          <div className="text-[#fbfdfc] text-[20px] leading-none" style={{ fontWeight: 400 }}>
