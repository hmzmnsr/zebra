...
const ProduzioneHero = () => {
  return (
    <section className="bg-cover bg-center bg-no-repeat text-white h-[864px] relative flex flex-col" style={{ backgroundImage: 'url(/assets/servizi2/1.png)' }}>
      {/* Black layer */}
      ...
      <div className="px-4 sm:px-6 lg:px-3 relative z-10 my-auto">
        ...
        <div className="max-w-6xl space-y-8">
          {/* First Paragraph */}
                    <p style={{ fontWeight: 300 }} className="text-[32px] text-gra
                    
                    y-100 leading-none font-sans">
