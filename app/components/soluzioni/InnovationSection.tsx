...
const InnovationSection = () => {
  return (
    <>
    <div className="relative h-px bg-gray-400 ml-168 top-32"></div>
        ...
        <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-1">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="order-2 lg:order-1">
              <h3 className="text-gray-300 text-[20px] font-thin px-4 sm:px-8 lg:px-32">
              Racconti da vivere
              </h3>
                             <h2 className="text-white text-[48px] font-thin leading-tight px-4 sm:px-8 lg:px-32 mb-8">
               Storytelling immersivi
               </h2>
               
              <p className="text-white text-[20px] leading-tight px-4 sm:px-8 lg:px-32 font-thin">
...
Per showroom, musei, stand fieristici, eventi, product reveal e contesti educativi. 
      ...
      <section className="pb-8 pt-6 md:pb-16 md:pt-12 bg-[linear-gradient(to_bottom,#252727_70%,white_70%)]">
        ...
        <div className="relative h-px bg-gray-400 right-18 bottom-120"></div>
      </section>
